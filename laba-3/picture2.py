...
line(surface, black, (0, 400), (600, 400), 4)
rect(surface, fiol, (0, 0, 600, 400))

circle(surface, blood, (350, 200), 100, 7)
polygon(surface, blood, [(290, 130), (350, 300), (410, 130),(260, 230), (440, 230), (290, 130)], 7)
...
def bear():
    ...
    tail = pygame.transform.scale(tail, (60, 40))
    tail = pygame.transform.rotate(tail, 30)
    pygame.Surface.blit(screen, tail, (370, 630))
    tail = pygame.transform.rotate(tail, 200)
    pygame.Surface.blit(screen, tail, (300, 600))
    tail = pygame.transform.rotate(tail, 100)
    pygame.Surface.blit(screen, tail, (360, 640))
    tail = pygame.transform.rotate(tail, 120)
    pygame.Surface.blit(screen, tail, (310, 610))
    tail = pygame.transform.rotate(tail, 200)
    pygame.Surface.blit(screen, tail, (380, 430))
    tail = pygame.transform.rotate(tail, 120)
    pygame.Surface.blit(screen, tail, (290, 420))
...
bear()
screen = pygame.transform.scale(screen, (300, 400))
pygame.Surface.blit(surface, screen, (0, 400))
screen = pygame.transform.flip(screen, 1, 0)
pygame.Surface.blit(surface, screen, (210, 300))
screen = pygame.transform.scale(screen, (200, 267))
pygame.Surface.blit(surface, screen, (50, 250))
